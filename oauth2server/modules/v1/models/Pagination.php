...
class Pagination extends Object implements Linkable {
    ...
    /**
     * @var string name of the parameter storing the page offset.
     * @see params
     */
    public $pageOffsetParam = 'offset';

    /**
     * @var integer offset value of the page.
     * If the number of items in the page is less than 1, the value is 0, else, the value is the pageSize multiplied to the cureent page number.
     */
    public $_pageOffset;
    ...
    public function createUrl($page, $pageSize = null, $absolute = false) {
        ...
        if (isset($params[$this->pageOffsetParam]) && !is_integer($params[$this->pageOffsetParam])) {
            unset($params[$this->pageOffsetParam]);
        }
    ...
    public function getOffset() {
        ...
        if ($this->_pageOffset === null) {
            ...
            $offset = (int) $this->getQueryParam($this->pageOffsetParam, $this->getPage() * $this->getPageSize());
